...
try {
    ...
    $sw1 = Start-Stopwatch
    Write-Host "started deploying 'predeployment.json'"
    ...
    $sw2 = Start-Stopwatch 
    Write-Host "started deploying 'main.json'"
    # $mainDeployment = new-azresourcegroupdeployment -TemplateFile .\main.bicep -TemplateParameterFile .\main.bicepparam 
    ...
    Write-Host "finished deploying 'main.json' in $($elapsedTime2)"
